...
if __name__ == "__main__":
    ...
    # Iterate through each test case, unpacking the nums, target, and expected_result
    for nums, target, expected_result in test_cases:
        test_two_sum(nums, target, expected_result)  # Call the test_two_sum function with the current test case
